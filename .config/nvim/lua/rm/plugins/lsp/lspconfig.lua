...
R.lsp.capabilities = require('cmp_nvim_lsp').update_capabilities(vim.lsp.protocol.make_client_capabilities())
...
setup 'taplo'
setup('graphql', {
  filetypes = { 'graphql', 'gql', 'graphqls', 'typescriptreact', 'javascriptreact' },
})
setup 'dockerls'
...
local sumneko_binary = HOME .. '/.config/lua-language-server/bin/macOS/lua-language-server'
setup('sumneko_lua', {
